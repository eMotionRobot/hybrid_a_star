...
修改：wuxy
日期：20171222
参考文献：https://www.cnblogs.com/wlzy/p/7096114.html
************************/
...
{
    clearList();  //clear list before operate list
...
bool Astar::isCanreach(const Point *point, const Point *target, bool isIgnoreCorner) const
{
	if (target->x<0 || target->x>maze.size() - 1
        || target->y<0 || target->y>maze[0].size() - 1  //超出地图
        || maze[target->x][target->y] == 1          //障碍物
